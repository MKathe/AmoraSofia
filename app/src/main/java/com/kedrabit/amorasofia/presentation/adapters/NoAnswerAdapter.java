...
public class NoAnswerAdapter extends LoaderAdapter<QuestionEntity> implements OnClickListListener {

    private Context context;
    private QuestionItem questionItem;

    public NoAnswerAdapter(ArrayList<QuestionEntity> placesEntities, Context context, QuestionItem questionItem) {
        super(context);
    ...
    public NoAnswerAdapter(ArrayList<QuestionEntity> orderEntities, Context context) {
        super(context);
